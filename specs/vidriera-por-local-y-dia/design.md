...
## UI
- Carga y modificación: modal `VidrieraModal` desde menú Personal (**Vidrieras**).
  El mismo modal sirve para alta y para cambiar/quitar locales de un día ya cargado.
...
- Mes (`MonthGantt`): comentario “Vidriera” en amarillo en la barra/tarjeta
  del turno. El nombre del local no cambia de color. Solo lectura.
